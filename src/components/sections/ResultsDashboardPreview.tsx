...
export default function ResultsDashboardPreview() {
  return (
    <section className="w-full bg-gray-900 py-24 text-white overflow-hidden relative">
      {/* Background Decor */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-deep-green/20 to-transparent pointer-events-none"></div>
          ...
          <div className="w-full lg:w-2/3">
            <div className="bg-[#111827] border border-gray-800 rounded-md shadow-2xl p-6 md:p-8 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                ...
                {/* Metric 3 */}
                <div className="bg-[#1f2937] p-5 rounded-sm border border-gray-700/50 flex flex-col justify-center">
              ...
              {/* Chart Mockup */}
              <div className="w-full h-32 border-l border-b border-gray-700 flex items-end justify-around pb-0 pt-4 px-2">
