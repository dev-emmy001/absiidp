    ...
    <footer className="bg-deep-green text-white">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-x-8 gap-y-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> {dictionary.footer.links.about}</Link></li>
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> {dictionary.footer.links.components}</Link></li>
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> {dictionary.footer.links.climate}</Link></li>
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> {dictionary.footer.links.waste}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> {dictionary.footer.links.faqs}</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> info@absiidp.gov.ng</Link></li>
              <li><Link href="#" className="group flex items-start gap-2 text-[13px] font-medium text-white hover:text-gold-accent transition-colors"><ArrowUpRight size={14} className="text-white mt-0.5 shrink-0 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform" /> +234 (0) 000 000 0000</Link></li>
            </ul>
          </div>
        ...
        <div className="bg-gray-50 rounded-sm p-6 md:p-8 flex flex-col md:flex-row items-center justify-center md:justify-between gap-6 mb-12">
          <p className="text-black font-semibold text-lg md:text-xl text-center md:text-left">
        ...
        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row items-center justify-between pt-8 text-[10px] uppercase tracking-wider font-semibold text-white gap-4 text-center md:text-left">
